...
export function spawnEnemy(
  ...
  return world.create({
    ...
    enemy: {
      ...
      dashCooldown: (def.spawnBehavior === 'dash' || def.spawnBehavior === 'lance' || def.spawnBehavior === 'blink') ? 2 + rng() * 2 : undefined,
      ...
      orbitAngle: (def.spawnBehavior === 'orbit' || def.spawnBehavior === 'spiral' || def.spawnBehavior === 'homing-orbit' || def.spawnBehavior === 'weave') ? rng() * Math.PI * 2 : undefined,
