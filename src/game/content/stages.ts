...
/** Stage 7 — "Resonance Field" · RESONANCE · Boss: Echo (strength ×6.5) — Act III trial */
const STAGE_7: StageConfig = {
  ...
  waves: [
    ...
    { index: 2,  durationHint: 24, spawns: [
      ...
      { t: 7,   kind: 'weave', count: 3 },
      { t: 14,  kind: 'shade', count: 2 },
    ] },
    { index: 3,  durationHint: 26, spawns: [
      { t: 0.5, kind: 'octo',  count: 2 },
      { t: 5,   kind: 'ring',  count: 2 },
      { t: 12,  kind: 'prism', count: 3 },
      { t: 18,  kind: 'weave', count: 3 },
    ] },
    { index: 4,  durationHint: 28, spawns: [
      { t: 0.5, kind: 'shade', count: 3 },
      { t: 0.5, kind: 'weave', count: 3 },
      { t: 7,   kind: 'ring',  count: 2 },
      { t: 7,   kind: 'octo',  count: 2 },
      { t: 14,  kind: 'prism', count: 3 },
      { t: 20,  kind: 'shade', count: 2 },
    ] },
    { index: 5,  durationHint: 30, spawns: [
      { t: 0.5, kind: 'ring',  count: 3 },
      { t: 6,   kind: 'octo',  count: 3 },
      { t: 6,   kind: 'weave', count: 3 },
      { t: 14,  kind: 'shade', count: 3 },
      { t: 14,  kind: 'prism', count: 2 },
      { t: 22,  kind: 'ring',  count: 2 },
    ] },
    { index: 6,  durationHint: 32, spawns: [
      { t: 0.5, kind: 'shade', count: 3 },
      { t: 0.5, kind: 'ring',  count: 3 },
      ...
      { t: 28,  kind: 'weave', count: 3 },
    ] },
    { index: 7,  durationHint: 36, spawns: [
      { t: 0.5, kind: 'ring',  count: 4 },
      { t: 0.5, kind: 'octo',  count: 3 },
      { t: 6,   kind: 'shade', count: 3 },
      { t: 6,   kind: 'weave', count: 4 },
      { t: 14,  kind: 'prism', count: 3 },
    ...
    { index: 8,  durationHint: 38, spawns: [
      ...
      { t: 22,  kind: 'octo',  count: 3 },
      { t: 30,  kind: 'weave', count: 4 },
      { t: 34,  kind: 'shade', count: 3 },
    ] },
    { index: 9,  durationHint: 40, spawns: [
      { t: 0.5, kind: 'ring',  count: 5 },
      { t: 0.5, kind: 'weave', count: 5 },
      { t: 6,   kind: 'shade', count: 4 },
      { t: 6,   kind: 'octo',  count: 4 },
      { t: 14,  kind: 'prism', count: 4 },
      { t: 14,  kind: 'ring',  count: 4 },
      { t: 22,  kind: 'shade', count: 4 },
      { t: 22,  kind: 'weave', count: 4 },
    ...
    { index: 10, durationHint: 42, spawns: [
      ...
      { t: 36,  kind: 'prism', count: 4 },
    ] },
    { index: 11, durationHint: 60, isBossWave: true, spawns: [] },
  ],
  beats: [
    { kind: 'eliteAmbush', afterWave: 5, enemyKind: 'ring', count: 3 },
    { kind: 'hazardWave', afterWave: 8, hazardId: 'phase-shift', duration: 5,
      spawns: [
        { t: 0.5, kind: 'ring',  count: 2 },
...
/** Stage 8 — "Fracture Zone" · FRACTURE · Boss: Shard (strength ×8.0) — Act III trial */
const STAGE_8: StageConfig = {
  stageId: 'stage8',
  bossId: 'shard',
  actId: 'collapse',
  ...
  waves: [
    { index: 1,  durationHint: 22, spawns: [
      { t: 0.5, kind: 'octo',  count: 2 },
      { t: 6,   kind: 'shade', count: 2 },
      { t: 14,  kind: 'weave', count: 3 },
    ] },
    { index: 2,  durationHint: 24, spawns: [
      { t: 0.5, kind: 'node',  count: 1 },
      { t: 7,   kind: 'weave', count: 3 },
      { t: 14,  kind: 'shade', count: 2 },
    ] },
    { index: 3,  durationHint: 26, spawns: [
      { t: 0.5, kind: 'thorn', count: 1 },
      { t: 5,   kind: 'weave', count: 3 },
      { t: 12,  kind: 'octo',  count: 2 },
    ...
    { index: 4,  durationHint: 28, spawns: [
      ...
      { t: 7,   kind: 'shade', count: 2 },
      { t: 14,  kind: 'octo',  count: 2 },
      { t: 20,  kind: 'weave', count: 3 },
    ] },
    { index: 5,  durationHint: 30, spawns: [
      { t: 0.5, kind: 'thorn', count: 2 },
      { t: 6,   kind: 'node',  count: 2 },
      { t: 6,   kind: 'weave', count: 4 },
      { t: 14,  kind: 'shade', count: 3 },
      { t: 14,  kind: 'octo',  count: 2 },
      { t: 22,  kind: 'thorn', count: 1 },
    ] },
    { index: 6,  durationHint: 32, spawns: [
      { t: 0.5, kind: 'node',  count: 2 },
      { t: 0.5, kind: 'weave', count: 4 },
      { t: 6,   kind: 'thorn', count: 2 },
      { t: 6,   kind: 'shade', count: 3 },
      { t: 14,  kind: 'octo',  count: 3 },
      { t: 14,  kind: 'weave', count: 3 },
      { t: 22,  kind: 'node',  count: 2 },
      { t: 28,  kind: 'thorn', count: 2 },
    ] },
    { index: 7,  durationHint: 36, spawns: [
    ...
    { index: 8,  durationHint: 38, spawns: [
      ...
      { t: 6,   kind: 'shade', count: 4 },
      { t: 14,  kind: 'octo',  count: 3 },
      { t: 14,  kind: 'weave', count: 4 },
      { t: 22,  kind: 'node',  count: 3 },
    ...
    { index: 9,  durationHint: 40, spawns: [
      ...
      { t: 0.5, kind: 'weave', count: 5 },
      { t: 6,   kind: 'node',  count: 3 },
      { t: 6,   kind: 'shade', count: 4 },
      { t: 14,  kind: 'octo',  count: 4 },
      { t: 14,  kind: 'thorn', count: 3 },
      { t: 22,  kind: 'weave', count: 5 },
      { t: 22,  kind: 'node',  count: 3 },
      { t: 30,  kind: 'shade', count: 4 },
      { t: 36,  kind: 'thorn', count: 3 },
    ] },
    { index: 10, durationHint: 42, spawns: [
      { t: 0.5, kind: 'node',  count: 4 },
      { t: 0.5, kind: 'thorn', count: 4 },
      { t: 6,   kind: 'weave', count: 5 },
      { t: 6,   kind: 'shade', count: 4 },
      { t: 14,  kind: 'octo',  count: 4 },
      { t: 14,  kind: 'node',  count: 3 },
      { t: 22,  kind: 'thorn', count: 4 },
      { t: 22,  kind: 'weave', count: 5 },
      { t: 30,  kind: 'shade', count: 5 },
      { t: 36,  kind: 'node',  count: 3 },
    ] },
    { index: 11, durationHint: 44, spawns: [
      { t: 0.5, kind: 'thorn', count: 5 },
      { t: 0.5, kind: 'node',  count: 4 },
      { t: 6,   kind: 'weave', count: 6 },
      { t: 6,   kind: 'shade', count: 5 },
      { t: 14,  kind: 'octo',  count: 4 },
      { t: 14,  kind: 'thorn', count: 4 },
      { t: 22,  kind: 'node',  count: 4 },
      { t: 22,  kind: 'weave', count: 5 },
      { t: 30,  kind: 'shade', count: 5 },
      { t: 36,  kind: 'thorn', count: 4 },
    ] },
    { index: 12, durationHint: 60, isBossWave: true, spawns: [] },
  ],
  beats: [
    { kind: 'eliteAmbush', afterWave: 4, enemyKind: 'thorn', count: 2 },
    { kind: 'miniBoss', afterWave: 9, enemyKind: 'node' },
  ],
};

/** Stage 9 — "Void Absolute" · VOID · Boss: Null (strength ×10.0) — Act III gate */
const STAGE_9: StageConfig = {
  stageId: 'stage9',
  bossId: 'null',
  actId: 'collapse',
  ...
  waves: [
    ...
    { index: 3,  durationHint: 26, spawns: [
      { t: 0.5, kind: 'node',  count: 2 },
      { t: 5,   kind: 'thorn', count: 2 },
      { t: 12,  kind: 'weave', count: 4 },
      { t: 18,  kind: 'ring',  count: 3 },
    ] },
    { index: 4,  durationHint: 28, spawns: [
      { t: 0.5, kind: 'shade', count: 4 },
      { t: 0.5, kind: 'weave', count: 4 },
      { t: 7,   kind: 'octo',  count: 3 },
      { t: 7,   kind: 'node',  count: 2 },
      { t: 14,  kind: 'thorn', count: 3 },
      { t: 20,  kind: 'ring',  count: 3 },
    ] },
    { index: 5,  durationHint: 30, spawns: [
      { t: 0.5, kind: 'node',  count: 3 },
      { t: 6,   kind: 'thorn', count: 3 },
    ...
    { index: 6,  durationHint: 32, spawns: [
      ...
      { t: 14,  kind: 'octo',  count: 3 },
      { t: 22,  kind: 'thorn', count: 4 },
      { t: 28,  kind: 'node',  count: 3 },
    ] },
    { index: 7,  durationHint: 36, spawns: [
      { t: 0.5, kind: 'node',  count: 4 },
      { t: 0.5, kind: 'weave', count: 6 },
      { t: 6,   kind: 'ring',  count: 4 },
      { t: 6,   kind: 'thorn', count: 4 },
      { t: 14,  kind: 'octo',  count: 4 },
      { t: 14,  kind: 'shade', count: 4 },
      { t: 22,  kind: 'weave', count: 5 },
      { t: 22,  kind: 'node',  count: 4 },
      { t: 30,  kind: 'thorn', count: 4 },
    ] },
    { index: 8,  durationHint: 38, spawns: [
      { t: 0.5, kind: 'thorn', count: 5 },
      { t: 0.5, kind: 'ring',  count: 5 },
      { t: 6,   kind: 'node',  count: 4 },
      { t: 6,   kind: 'weave', count: 6 },
      { t: 14,  kind: 'shade', count: 5 },
      { t: 14,  kind: 'octo',  count: 4 },
      { t: 22,  kind: 'ring',  count: 5 },
      { t: 22,  kind: 'node',  count: 4 },
      { t: 30,  kind: 'thorn', count: 4 },
      { t: 36,  kind: 'weave', count: 5 },
    ] },
    { index: 9,  durationHint: 40, spawns: [
      { t: 0.5, kind: 'node',  count: 5 },
      { t: 0.5, kind: 'thorn', count: 5 },
      { t: 6,   kind: 'ring',  count: 5 },
      { t: 6,   kind: 'weave', count: 6 },
      { t: 14,  kind: 'shade', count: 5 },
      { t: 14,  kind: 'octo',  count: 4 },
      { t: 22,  kind: 'node',  count: 5 },
      { t: 22,  kind: 'thorn', count: 4 },
      { t: 30,  kind: 'ring',  count: 5 },
      { t: 36,  kind: 'weave', count: 6 },
    ] },
    { index: 10, durationHint: 42, spawns: [
      { t: 0.5, kind: 'thorn', count: 6 },
      { t: 0.5, kind: 'node',  count: 5 },
      { t: 6,   kind: 'ring',  count: 5 },
      { t: 6,   kind: 'weave', count: 7 },
      { t: 14,  kind: 'shade', count: 5 },
      { t: 14,  kind: 'octo',  count: 5 },
      { t: 22,  kind: 'node',  count: 5 },
      { t: 22,  kind: 'thorn', count: 5 },
      { t: 30,  kind: 'ring',  count: 5 },
      { t: 36,  kind: 'weave', count: 6 },
    ] },
    { index: 11, durationHint: 44, spawns: [
      { t: 0.5, kind: 'node',  count: 6 },
      { t: 0.5, kind: 'ring',  count: 6 },
      { t: 6,   kind: 'thorn', count: 6 },
      { t: 6,   kind: 'weave', count: 7 },
      { t: 14,  kind: 'shade', count: 6 },
      { t: 14,  kind: 'octo',  count: 5 },
      { t: 22,  kind: 'node',  count: 5 },
      { t: 22,  kind: 'thorn', count: 5 },
      { t: 30,  kind: 'ring',  count: 6 },
      { t: 36,  kind: 'weave', count: 7 },
    ] },
    { index: 12, durationHint: 46, spawns: [
      { t: 0.5, kind: 'thorn', count: 7 },
      { t: 0.5, kind: 'node',  count: 6 },
      { t: 6,   kind: 'ring',  count: 6 },
      { t: 6,   kind: 'weave', count: 8 },
      { t: 14,  kind: 'shade', count: 6 },
      { t: 14,  kind: 'octo',  count: 5 },
      { t: 22,  kind: 'node',  count: 6 },
      { t: 22,  kind: 'thorn', count: 6 },
      { t: 30,  kind: 'ring',  count: 6 },
      { t: 36,  kind: 'weave', count: 7 },
    ] },
    { index: 13, durationHint: 48, spawns: [
      { t: 0.5, kind: 'node',  count: 7 },
      { t: 0.5, kind: 'thorn', count: 7 },
      { t: 6,   kind: 'ring',  count: 7 },
      { t: 6,   kind: 'weave', count: 8 },
      { t: 14,  kind: 'shade', count: 7 },
      { t: 14,  kind: 'octo',  count: 6 },
      { t: 22,  kind: 'node',  count: 6 },
      { t: 22,  kind: 'thorn', count: 6 },
      { t: 30,  kind: 'ring',  count: 7 },
      { t: 36,  kind: 'weave', count: 8 },
    ] },
    { index: 14, durationHint: 60, isBossWave: true, spawns: [] },
  ],
  beats: [
    { kind: 'hazardWave', afterWave: 6, hazardId: 'void-field', duration: 6,
      spawns: [
        { t: 0.5, kind: 'thorn', count: 2 },
        { t: 3.0, kind: 'node',  count: 2 },
      ] },
    { kind: 'eliteAmbush', afterWave: 11, enemyKind: 'node', count: 3 },
    { kind: 'puzzle', afterWave: 13, duration: 5 },
  ],
};
