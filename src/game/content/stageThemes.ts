...
export const STAGE_THEMES: readonly StageTheme[] = [
  ...
  },
  {
    ...
    background: 0x0e0a1e,
    gridColor: 0x2a1440,
    overlayBg: "rgba(14,10,30,0.62)",
    dark: true,
    playerColor: 0xb39ddb,
    enemyStroke: 0xce93d8,
    fogColor: 0x9c27b0,
    fogAlpha: 0.20,
    bossId: "echo",
    domainName: "RESONANCE",
    theoremLine: '"every pattern finds its echo"',
    accentTint: "rgba(179,157,219,0.10)",
  },
  {
    name: "Fracture Zone",
    background: 0x1a0810,
    gridColor: 0x3a1020,
    overlayBg: "rgba(26,8,16,0.62)",
    dark: true,
    playerColor: 0xef9a9a,
    enemyStroke: 0xff5252,
    fogColor: 0xe53935,
    fogAlpha: 0.22,
    bossId: "shard",
    domainName: "FRACTURE",
    theoremLine: '"the whole is less than its fragments"',
    accentTint: "rgba(239,154,154,0.10)",
  },
  {
    name: "Void Absolute",
    background: 0x000000,
  ...
  // ── Act IV — INDUCTION ──────────────────────────────────────────────────────
  {
    name: "Recursion Field",
    background: 0x0d1422,
    gridColor: 0x1a2540,
    overlayBg: "rgba(13,20,34,0.62)",
    dark: true,
    playerColor: 0xa5d6a7,
    enemyStroke: 0xc8e6c9,
    fogColor: 0x4caf50,
    fogAlpha: 0.18,
    bossId: "iterate",
    domainName: "RECURSION",
    theoremLine: '"every result reapplies itself"',
    accentTint: "rgba(165,214,167,0.10)",
  },
  {
    name: "Fixpoint Attractor",
    background: 0x180e1e,
    gridColor: 0x2c1838,
    overlayBg: "rgba(24,14,30,0.62)",
    dark: true,
    playerColor: 0xffcc80,
    enemyStroke: 0xffe0b2,
    fogColor: 0xff9800,
    fogAlpha: 0.18,
    bossId: "limit",
    domainName: "FIXPOINT",
    theoremLine: '"convergence is its own attack"',
    accentTint: "rgba(255,204,128,0.10)",
  },
  {
    name: "Hypergrid",
    background: 0x05050a,
    gridColor: 0x141428,
    overlayBg: "rgba(5,5,10,0.72)",
    dark: true,
    playerColor: 0xfff59d,
    enemyStroke: 0xfff9c4,
    fogColor: 0xffeb3b,
    fogAlpha: 0.12,
    bossId: "theorem",
    domainName: "HYPERGRID",
    theoremLine: '"the proof concludes"',
    accentTint: "rgba(255,245,157,0.08)",
  },
];
